...
trait HubOptions {
    ...
    @Option(names = ['--hub'], description = "Service hub where the project is hosted", paramLabel = "Service_Name")
    String hubProvider

    @Option(names=['--user'], description = 'Private repository user name',paramLabel = "User_Name")
    String hubUser
